    ...
    function setup(vm, scope) {
      ...
      return _.assign(vm, {
        ...
        setBusy: function setBusy(promise, message) {
          ...
          if (!busyArray.length) {
            ...
            vm.busy = $q(function (resolve, reject) {
              ...
              promise.then(function () {
                return $timeout().then(popResolver);
              }, reject);
            });

            vm.busy.catch(function () {
              vm.busy = false;
              busyArray = [];
            });
          ...
          busyArray.push({ promise: promise, message: message });
...
(function () {
  ...
  angular.module('sistemium.services').service('Editing', Editing);
